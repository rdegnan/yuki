...
(* OASIS_START *)
(* DO NOT EDIT (digest: 40fb84a9863d7982cb8273d9ff54fcf1) *)
(*
...
(* # 21 "/Users/matthew/.opam/system/build/oasis.0.3.0/src/plugins/ocamlbuild/OCamlbuildCommon.ml" *)
...
(* # 21 "/Users/matthew/.opam/system/build/oasis.0.3.0/src/plugins/ocamlbuild/OCamlbuildPlugin.ml" *)
...
(* # 21 "/Users/matthew/.opam/system/build/oasis.0.3.0/src/plugins/ocamlbuild/OCamlbuildDocPlugin.ml" *)
...
let setup_t =
  {
          ...
          clean_custom =
            {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("rm", ["-f"; "src/{yuki,yuki_tree}_{j,t}.*"])))
                 ];
               };
          distclean_custom =
            {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "åâp¨NLú\142\157Ç$\"W\003ª¹";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
